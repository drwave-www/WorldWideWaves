...
class FullMapScreenMapTest : BaseMapIntegrationTest() {
    ...
    fun testFullMap_preventiveConstraints_neverShowOutsidePixels() =
        runBlocking {
            ...
            val minZoom = runOnUiThread { adapter.getMinZoomLevel() }
    ...
    fun testFullMap_visibleRegionStaysWithinBounds_atDifferentZoomLevels() =
        runBlocking {
            ...
            zoomLevels.forEach { zoom ->
                ...
                var visibleRegion = runOnUiThread { adapter.getVisibleRegion() }
    ...
    fun testFullMap_cameraClampedWhenPanningTowardBoundary() =
        runBlocking {
            ...
            val clampedPosition = runOnUiThread { adapter.getCameraPosition() }
            val clampedVisibleRegion = runOnUiThread { adapter.getVisibleRegion() }
    ...
    fun testFullMap_canZoomInWhileStuckToEdge() =
        runBlocking {
            ...
            // Verify at edge
            val regionAtMinZoom = runOnUiThread { adapter.getVisibleRegion() }
            assertTrue(
    ...
    fun testFullMap_canZoomOutWhileStuckToEdge() =
        runBlocking {
            ...
            val regionAtHigherZoom = runOnUiThread { adapter.getVisibleRegion() }
    ...
    fun testFullMap_autoTargetsUserOnFirstGpsFix() =
        runBlocking {
            ...
            val cameraAfterGps = runOnUiThread { adapter.getCameraPosition() }
    ...
    fun testFullMap_noRecalculationOnMinorDimensionChange() =
        runBlocking {
            ...
            val regionAfterMinorChange = runOnUiThread { adapter.getVisibleRegion() }
