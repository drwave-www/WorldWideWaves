...
echo "   - Automatic Android emulator launch for integration tests"
echo "   - Translation updates (with OPENAI_API_KEY)"
echo "   - Critical integration test execution before push"
echo ""
echo "💡 To disable integration tests temporarily: SKIP_INTEGRATION_TESTS=1 git push"
echo "💡 To update hooks: git pull && ./scripts/setup-git-hooks.sh"
