...
kotlin {
    ...
    listOf(
        ...
        // Note: Crashlytics cinterop disabled on iOS due to Firebase Swift dependencies
        // iOS app uses Firebase Crashlytics directly for native crashes
        // Kotlin shared code crashes on iOS are not logged to Crashlytics (Android only)
    }

    /*
     * Note: iOS Crashlytics bridge tasks removed
     *
     * Reason: Firebase iOS SDK contains Swift dependencies that conflict with Kotlin/Native linking.
     * Solution: iOS app uses Firebase Crashlytics directly for native crash reporting.
     * Android continues to use Crashlytics from Kotlin shared code.
     *
    ...
    sourceSets {
        ...
        commonMain.dependencies {
            ...
            implementation("org.jetbrains.androidx.lifecycle:lifecycle-common:2.10.0")
        }
