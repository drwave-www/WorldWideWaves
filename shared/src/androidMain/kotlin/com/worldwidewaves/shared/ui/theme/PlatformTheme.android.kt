...
/**
 * Android implementation using equivalent styling to original Android theme.
 */
...
actual fun platformExtraQuinaryColoredBoldTextStyle(fontSize: Int): TextStyle =
    TextStyle(fontSize = fontSize.sp, fontWeight = FontWeight.Bold, color = Color(0xFFE0E0E0))

actual fun platformQuinaryColoredTextStyle(fontSize: Int): TextStyle =
    TextStyle(fontSize = fontSize.sp, color = Color(0xFFE0E0E0))
...
actual fun platformPrimaryColoredBoldTextStyle(fontSize: Int): TextStyle =
    TextStyle(fontSize = fontSize.sp, fontWeight = FontWeight.Bold, color = Color(0xFF1976D2))
...
// Platform stroke constants from original Event constants
actual val platformDateMiter: Float = 4.0f // Event.DATE_MITER
actual val platformDateStroke: Float = 2.0f // Event.DATE_STROKE
