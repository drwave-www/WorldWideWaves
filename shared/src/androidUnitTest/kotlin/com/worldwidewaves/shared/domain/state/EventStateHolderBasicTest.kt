...
class EventStateHolderBasicTest {
    ...
    fun `validateState detects status-progression inconsistencies`() {
        ...
        val doneIssues = eventStateHolder.validateState(doneInput, doneState)
        ...
        val runningIssues = eventStateHolder.validateState(runningInput, runningState)
    ...
    fun `validateStateTransition detects invalid status transitions`() {
        ...
        val doneToRunningIssues = eventStateHolder.validateStateTransition(doneState, runningState)
        ...
        val backwardIssues = eventStateHolder.validateStateTransition(runningToPrevious, soonState)
    ...
    fun `validateStateTransition prevents hit state reversal`() {
        ...
        val issues = eventStateHolder.validateStateTransition(hitState, notHitState)
