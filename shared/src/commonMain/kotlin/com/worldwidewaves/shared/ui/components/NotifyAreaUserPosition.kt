...
@Composable
fun SharedNotifyAreaUserPosition(
    event: IWWWEvent,
    ...
    // Platform-specific text wrapping for internationalization
    val displayText = PlatformBidiWrap(geolocText)
...
/**
 * Platform-specific text wrapping for internationalization.
 * Android: Uses BidiFormatter.getInstance().unicodeWrap()
 * iOS: Uses equivalent text wrapping
 */
expect fun PlatformBidiWrap(text: String): String