...
/**
 * Shared text utility that renders [text] on a SINGLE line, automatically
 * shrinking the font size until it fits the available width (down to [minFontSizeSp]).
 *
 * Useful for variable-length strings that must never wrap – e.g. headings or
 * status banners. Works identically on both Android and iOS.
 */
@Composable
