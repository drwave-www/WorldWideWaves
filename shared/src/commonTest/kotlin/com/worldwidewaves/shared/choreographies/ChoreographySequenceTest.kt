...
class ChoreographySequenceTest {
    ...
    private fun createMockResolver(): ImageResolver<TestImage> =
        mockk<ImageResolver<TestImage>>().also { resolver ->
