...
class ErrorHandlingTest : KoinTest {
    ...
    @Test
    fun `test network failure during event loading should handle gracefully`() =
        runTest {
    ...
    @Test
    fun `test observer handles timeouts during operations`() =
        runTest {
    ...
    @Test
    fun `test resource loading failure with fallback mechanisms`() =
        runTest {
            ...
            try {
                ...
                fallbackUsed = true
                assertTrue(
                    e.message?.contains("Resource not found") == true,
    ...
    @Test
    fun `test malformed event data handling`() =
        runTest {
    ...
    @Test
    fun `test invalid date format handling`() =
        runTest {
    ...
    @Test
    fun `test corrupted wave data recovery`() =
        runTest {
            // GIVEN: Wave with corrupted parameters
            val corruptedWaveScenarios =
                listOf(
    ...
    @Test
    fun `test concurrent observer modifications`() =
        runTest {
    ...
    @Test
    fun `test rapid start-stop observer cycles`() =
        runTest {
    ...
    @Test
    fun `test large data handling memory efficiency`() =
        runTest {
    ...
    @Test
    fun `test wave calculation memory limits`() =
        runTest {
    ...
    @Test
    fun `test observer graceful degradation during failures`() =
        runTest {
    ...
    @Test
    fun `test event validation with minimal required fields`() =
        runTest {
    ...
    @Test
    fun `test system recovery after multiple cascading failures`() =
        runTest {
    ...
    @Test
    fun `test invalid country and community handling`() =
        runTest {
