...
class ResourceExhaustionTest : KoinTest {
    ...
    @Test
    fun `should handle excessive coroutine spawning gracefully`() =
        runTest {
            ...
            assertTrue(
                resourceExhaustionHandled || observers.size == 100,
                "System should either handle 100 observers or fail gracefully",
            )
        }

    @Test
    fun `should handle memory pressure during large waveform generation`() =
        runTest {
    ...
    @Test
    fun `should recover from temporary resource unavailability`() =
        runTest {
    ...
    @Test
    fun `should handle CPU-intensive operations without blocking`() =
        runTest {
    ...
    @Test
    fun `should throttle excessive concurrent operations`() =
        runTest {
    ...
    @Test
    fun `should handle gradual memory degradation gracefully`() =
        runTest {
    ...
    @Test
    fun `should maintain core functionality under resource pressure`() =
        runTest {
            ...
            assertTrue(
                coreFunctionalityMaintained,
                "Core functionality should be maintained under resource pressure",
            )
        }

    @Test
    fun `should implement circuit breaker pattern for failing operations`() =
        runTest {
