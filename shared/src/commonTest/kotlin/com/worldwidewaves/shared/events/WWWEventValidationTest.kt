...
class WWWEventValidationTest : KoinTest {
    ...
    @Test
    fun `event in future should have NEXT status`() =
        runTest {
    ...
    @Test
    fun `event within soon delay should have SOON status`() =
        runTest {
    ...
    @Test
    fun `running event should have RUNNING status`() =
        runTest {
    ...
    @Test
    fun `completed event should have DONE status`() =
        runTest {
    ...
    @Test
    fun `timezone calculations should work correctly across DST boundaries`() =
        runTest {
    ...
    @Test
    fun `status calculation verifies event timing logic works`() =
        runTest {
    ...
    fun `comprehensive invalid data error message quality`() {
        ...
        testCases.forEach { (invalidValue, expectedErrorSubstring, description) ->
            ...
            assertTrue(
                errors.any { it.contains(expectedErrorSubstring) },
