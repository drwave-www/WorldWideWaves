...
class PolygonSplittingComplexityTest {
    ...
    @Test
    fun `test simple rectangular polygon with straight longitude cut`() =
        runTest {
    ...
    @Test
    fun `test L-shaped polygon with straight longitude cut`() =
        runTest {
    ...
    @Test
    fun `test star-shaped polygon with curved longitude cut`() =
        runTest {
    ...
    @Test
    fun `test concave polygon with multiple indentations`() =
        runTest {
    ...
    @Test
    fun `test polygon with hole (donut shape)`() =
        runTest {
    ...
    @Test
    fun `test very thin polygon with composed longitude`() =
        runTest {
    ...
    @Test
    fun `test polygon with many vertices (high vertex count)`() =
        runTest {
    ...
    @Test
    fun `test edge case - polygon entirely on one side`() =
        runTest {
            // Edge case: Polygon entirely on one side of cut
            val rightSidePolygon =
                Polygon.fromPositions(
    ...
    @Test
    fun `test vertex ordering consistency across different polygon types`() =
        runTest {
