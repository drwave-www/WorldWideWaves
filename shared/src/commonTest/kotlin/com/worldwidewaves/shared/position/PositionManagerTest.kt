...
class PositionManagerTest {
    ...
    private class TestCoroutineScopeProvider(private val testScope: TestScope) : CoroutineScopeProvider {
    ...
    @Test
    fun `should emit initial null position`() = runTest {
    ...
    @Test
    fun `should update position from GPS source`() = runTest {
        val coroutineScopeProvider = TestCoroutineScopeProvider(this)
    ...
    @Test
    fun `should prioritize simulation over GPS`() = runTest {
        val coroutineScopeProvider = TestCoroutineScopeProvider(this)
        val positionManager = PositionManager(coroutineScopeProvider, debounceDelay = 0.milliseconds)
        val gpsPosition = Position(lat = 48.8566, lng = 2.3522)
    ...
    @Test
    fun `should reject lower priority position updates`() = runTest {
        val coroutineScopeProvider = TestCoroutineScopeProvider(this)
        val positionManager = PositionManager(coroutineScopeProvider, debounceDelay = 0.milliseconds)
    ...
    @Test
    fun `should deduplicate identical positions`() = runTest {
        val coroutineScopeProvider = TestCoroutineScopeProvider(this)
        val positionManager = PositionManager(coroutineScopeProvider, debounceDelay = 0.milliseconds)
    ...
    @Test
    fun `should not deduplicate significantly different positions`() = runTest {
        val coroutineScopeProvider = TestCoroutineScopeProvider(this)
        val positionManager = PositionManager(coroutineScopeProvider, debounceDelay = 0.milliseconds)
    ...
    @Test
    fun `should debounce rapid position updates`() = runTest {
        val coroutineScopeProvider = TestCoroutineScopeProvider(this)
    ...
    @Test
    fun `should clear position from specific source`() = runTest {
        val coroutineScopeProvider = TestCoroutineScopeProvider(this)
        val positionManager = PositionManager(coroutineScopeProvider, debounceDelay = 0.milliseconds)
        val gpsPosition = Position(lat = 48.8566, lng = 2.3522)
    ...
    @Test
    fun `should clear all position data`() = runTest {
        val coroutineScopeProvider = TestCoroutineScopeProvider(this)
        val positionManager = PositionManager(coroutineScopeProvider, debounceDelay = 0.milliseconds)
        val position = Position(lat = 48.8566, lng = 2.3522)
    ...
    @Test
    fun `should handle concurrent position updates from different sources`() = runTest {
        val coroutineScopeProvider = TestCoroutineScopeProvider(this)
        val positionManager = PositionManager(coroutineScopeProvider, debounceDelay = 0.milliseconds)
        val gpsPosition = Position(lat = 48.8566, lng = 2.3522)
        val simulationPosition = Position(lat = 40.7128, lng = -74.0060)
    ...
    @Test
    fun `should handle null position updates`() = runTest {
        val coroutineScopeProvider = TestCoroutineScopeProvider(this)
        val positionManager = PositionManager(coroutineScopeProvider, debounceDelay = 0.milliseconds)
        val position = Position(lat = 48.8566, lng = 2.3522)
    ...
    @Test
    fun `cleanup should cancel pending operations`() = runTest {
        val coroutineScopeProvider = TestCoroutineScopeProvider(this)
        val positionManager = PositionManager(coroutineScopeProvider, debounceDelay = 100.milliseconds)
        val position = Position(lat = 48.8566, lng = 2.3522)
