...
object TestDataBuilders {
    ...
    class PolygonBuilder {
        ...
        fun radius(km: Double) =
            apply {
                require(km > 0) { "Radius must be positive: $km" }
                this.radiusKm = km
            }

        fun vertices(count: Int) =
            apply {
...
fun Position.isNear(
    other: Position,
    toleranceKm: Double = 1.0,
): Boolean = this.distanceTo(other) <= toleranceKm
