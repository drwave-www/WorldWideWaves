...
class HelpersTest {
    ...
    @Test
    fun `test updateIfChanged updates value when different`() = runTest {
        // Arrange
    ...
    @Test
    fun `test updateIfChanged does not update value when same`() = runTest {
        // Arrange
    ...
    @Test
    fun `test updateIfChanged with various primitive types`() = runTest {
        // Integer test
    ...
    @Test
    fun `test updateIfChanged with null values`() = runTest {
    ...
    @Test
    fun `test updateIfChanged with collections`() = runTest {
        // List test
    ...
    @Test
    fun `test updateIfChanged with custom data class`() = runTest {
        ...
        assertEquals(TestData(1, "test"), dataFlow.value, "Data class should be updated even with same content due to reference equality")
    ...
    @Test
    fun `test updateIfChanged with custom class using equals override`() = runTest {
        // Define a class with custom equals implementation
        class CustomEqualsClass(val value: String) {
    ...
    @Test
    fun `test subscribers are only notified when value actually changes`() = runTest {
    ...
    @Test
    fun `test performance by counting actual updates`() = runTest {
        // Create a wrapper to count actual updates
        class UpdateCounter<T>(initialValue: T) {
    ...
    @Test
    fun `test with large number of identical updates`() = runTest {
